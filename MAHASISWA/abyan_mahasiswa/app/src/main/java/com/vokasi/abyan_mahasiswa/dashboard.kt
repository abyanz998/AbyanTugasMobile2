...
import com.vokasi.abyan_mahasiswa.MainActivity
import com.vokasi.abyan_mahasiswa.R
...
class dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        input.setOnClickListener {
            val intent= Intent(context,com.vokasi.abyan_mahasiswa.input::class.java)
            startActivity(intent)
            finish()
        }

        // ini fungsi untuk nampilin data dalam bentuk recycelr view
        AndroidNetworking.get("http://192.168.43.68/mahasiswa/data_mahasiswa.php")
